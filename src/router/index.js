...
export const constantRoutes = [   //常规配置 一个登陆页，一个布局页，权限菜单处理的页面都会追加到布局页chil里面
  {
    path: '/',
    redirect:'/home'
  },
...
export const asyncRoutes = [   //异步路由  追加到布局页首页里面的内容 根据后端返回的roles不同展示不同，这里就是需要确定roles的种类
  {
    path: '/index',   //首页
    name: 'index',
    meta:{title:'首页',roles: ['input','approve']},
  ...
  },
  {
    path: '/contract',
    name: 'contract',
    meta: { title: '通知书管理' ,roles: ['approve']},
